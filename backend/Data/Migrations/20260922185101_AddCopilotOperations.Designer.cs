...
namespace backend.Data.Migrations
{
    ...
    [Migration("20260922185101_AddCopilotOperations")]
    partial class AddCopilotOperations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StayFlow.Api.Models.ConversationMessage", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("UX_ConversationMessages_CompanyId_IdempotencyKey")
            ...
            modelBuilder.Entity("StayFlow.Api.Models.CopilotOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompanyId", "ConversationId", "ActorUserId", "OperationType");

                    b.ToTable("CopilotOperations", (string)null);
                });
            ...
            modelBuilder.Entity("StayFlow.Api.Models.CopilotOperation", b =>
                {
                    b.HasOne("StayFlow.Api.Models.User", "ActorUser")
                        .WithMany("CopilotOperations")
            ...
            modelBuilder.Entity("StayFlow.Api.Models.Company", b =>
                {
                    ...
                    b.Navigation("CopilotOperations");
