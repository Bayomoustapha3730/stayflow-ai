...
public sealed class HostNotificationRecordConfiguration : IEntityTypeConfiguration<HostNotificationRecord>
{
    public void Configure(EntityTypeBuilder<HostNotificationRecord> builder)
    {
